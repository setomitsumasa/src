...
* `exclude_height_min` (double, default: 0.2) - The lower bound of the height band to exclude in meters.
* `exclude_height_max` (double, default: 0.6) - The upper bound of the height band to exclude in meters.
