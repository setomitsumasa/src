...
//            base_link -> livox_frame, camera_link, camera_color_frame, camera_color_optical_frame,
...
private:
    ...
    void publishTransforms()
    {
        ...
        transforms.push_back(createTransform(now, "camera_link", "camera_color_frame",
            camera_color_offset_x_, camera_color_offset_y_, camera_color_offset_z_,
            0.0, 0.0, 0.0, 1.0));
        transforms.push_back(createTransform(now, "camera_link", "camera_depth_frame",
            camera_depth_offset_x_, camera_depth_offset_y_, camera_depth_offset_z_,
            0.0, 0.0, 0.0, 1.0));
